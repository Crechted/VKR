...
from LOGO.utils.replay_memory import Memory
...
class Agent:
    ...
    def __init__(self, args, env, policy, device, eval_env=None, custom_reward=None, running_state=None, num_threads=1):
        self.env = env
        self.policy = policy
        self.device = device
